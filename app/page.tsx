  ...
  return (
    <main className="relative h-dvh w-full touch-none overflow-hidden bg-linear-to-b from-orange-50 to-white">
      ...
      <button
        ...
        onClick={reset}
        aria-label="처음 화면으로"
        className="absolute right-23 top-4 z-50 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 text-gray-500 shadow-sm hover:bg-white"
      >
      ...
      <button
        ...
        className="absolute right-4 top-4 z-50 rounded-full bg-white/80 px-3 py-2 text-xs font-medium text-gray-500 shadow-sm hover:bg-white"
      >
